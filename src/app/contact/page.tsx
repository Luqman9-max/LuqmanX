          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
            ...
            <div className="flex flex-col items-start">
              ...
              <MotionReveal variant="wordReveal" className="mb-8">
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-display font-bold text-white leading-tight tracking-tight">
                  Initialize <br />
                  ...
                  <div className="mb-auto">
                    ...
                    <div className="grid grid-cols-7 gap-1">
                      {Array.from({ length: 21 }).map((_, i) => (
                        <div key={i} className={`h-4 rounded-sm ${[0, 4, 8, 14, 19].includes(i) ? 'bg-purple-500/20 border border-purple-500/30' : [2, 7, 12, 18].includes(i) ? 'bg-dark-800' : 'bg-orange-500/20 border border-orange-500/30'}`} />
                      ))}
                    </div>
